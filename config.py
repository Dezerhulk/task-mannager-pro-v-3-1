...
class Settings(BaseSettings):
    ...
    def validate_secret_key(self):
        ...
        if explicit_development:
            logger.warning(
                "SECRET_KEY is unset or a placeholder; using development-only default. "
        ...
        raise ValueError(
            "SECRET_KEY must be set to a non-placeholder value unless development mode is explicitly enabled"
        )
